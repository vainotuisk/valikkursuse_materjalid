...
## Tee muutuja ruum ja sea see v6rduma viie-elemendilise j2rjendiga. Esimene element on ruumi kirjeldus, j2rgmised 4 on ruumi number kui m2ngija
...
##  anna kasutajale ka vihje, mis t2hti ta kasutada saab.
...
##  Kui kasutaja soovib suunduda p6hja (n) siis tee muutuja jargmine_ruum ja sea see v6rduma ruumid[asukoht][1]]
##  mis on p6hjasuuna ruumi number järjendis.
...
##  Lisa elif-laused ida-, l6una- ja l22nesuuna valikuks.
##  Samuti lisa else-lause juhuks kui programm ei saa aru, mis m2rk sisestati.


    
##  Testi m2ngu
## Arendusv6imalusi:
##  Lisa m2ngust v2ljumise valik, lisa v6imalus, et programm to'o'taks ka suurte t2htedega jne.           
...
>>>>>>> 09a0c75dd66752b7155578c7c0c6b8ea4767d903
